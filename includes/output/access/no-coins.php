...
<div class="loopis-message warning">
	...
	<p><a href="<?php echo esc_url(home_url('/submit'))?>"><span class="link">💚 Ge bort</span></a> &nbsp;
	<span class="link"><a href="<?php echo esc_url(add_query_arg('option', 'coins-stripe', network_home_url('/shop/')))?>">💰 Köp mynt</a></span></p>
