...
<link rel="preload" href="<?php echo esc_url( LOOPIS_THEME_URI . '/assets/fonts/css/brands.min.css' ); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
<noscript>
    ...
    <link href="<?php echo esc_url( LOOPIS_THEME_URI . '/assets/fonts/css/brands.min.css' ); ?>" rel="stylesheet">
</noscript>