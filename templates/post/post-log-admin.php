...
<?php if (in_category( 'booked_locker' )) { ?>
	<p><i class="fas fa-check-square"></i><?php echo get_the_author_posts_link(); ?> – <i class="fas fa-walking"></i><?php echo get_field('location'); ?>...<span><?php include LOOPIS_THEME_DIR . '/templates/post/timer-locker.php';?></span></p>
<?php } ?>
	
<?php if (in_category( 'booked_custom' )) { ?>
<p><i class="fas fa-mobile-alt"></i><a href="<?php echo esc_url($fetcherlink); ?>"><?php echo $fetchername; ?></a> – <i class="fas fa-walking"></i><?php echo get_field('location'); ?>...<span><?php include LOOPIS_THEME_DIR . '/templates/post/timer-locker.php';?></span></p>
<?php } ?>
...
<p><i class="far fa-square"></i><a href="<?php echo esc_url($fetcherlink); ?>"><?php echo $fetchername; ?></a> <i class="fas fa-walking"></i><?php echo get_field('location'); ?>...<span><?php include LOOPIS_THEME_DIR . '/templates/post/timer-fetch.php';?></span></p>
<?php } ?>
