...
// Archived posts?
if ($archived > 0) {
    echo '<p><span class="mega-link notif" onclick="window.location.href=\'/pages/profile/posts/?status=archived\'">⭕ Du har ' . $archived . ($archived === 1 ? ' arkiverad annons' : '') . ($archived > 1 ? ' arkiverade annonser' : '') . ' →</span></p>';
}
