...
if (current_user_can('member') || current_user_can('administrator')) {
    include_once LOOPIS_THEME_DIR . '/assets/output/user/front-page/front-alerts.php';
    include_once LOOPIS_THEME_DIR . '/assets/output/user/front-page/front-forum.php';
} else { include_once LOOPIS_THEME_DIR . '/assets/output/user/front-page/front-message.php'; }
...
<div class="column2"><a href="/gifts-random/">🤹 Fyndhörnan →</a></div></div>
<hr>
<div class="post-list">
