    ...
    <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
        <div class="post-list-post notif" style="position:relative;" onclick="location.href='<?php the_permalink(); ?>';">
            ...
            <div class="notif-meta post-list-post-meta">
				<p><span><?php include LOOPIS_THEME_DIR . '/assets/output/post/gift/timer-fetch.php';?></span> 🔓<span class="code"><?php echo get_option('loopis_locker_code_12845-1', 'kod saknas!'); ?></span></p>
            </div>
        </div>
