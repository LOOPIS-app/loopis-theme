<?php
/**
 * Show user with access to admin dashboard
 */
...
?>
        <p class="small">Local admin (manager):
            <?php
        ...
        <p class="small">Develooper (develooper):
            <?php
        ...
        <p class="small">WP-Admin (administrator):
            <?php
