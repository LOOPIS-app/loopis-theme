<?php
/**
 * WPUM template for displaying the password change form.
 *
 * Modified by LOOPIS.
 */
...
<div class="wpum-template wpum-form wpum-password-form">
	...
	<form action="<?php echo esc_url( $data->action ); ?>" method="post" id="wpum-submit-password-form" enctype="multipart/form-data">
		...
		<input type="submit" name="submit_password" class="button" value="<?php esc_html_e( 'Spara lösenord', 'wp-user-manager' ); ?>" />
